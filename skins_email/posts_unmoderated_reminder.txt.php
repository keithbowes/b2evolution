...
echo sprintf( T_('There have been posts awaiting moderation for more than %s in the following blogs:'), seconds_to_period( $Settings->get( 'post_moderation_reminder_threshold' ) ) );
echo "\n\n";
