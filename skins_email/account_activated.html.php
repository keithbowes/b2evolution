...
{ // Hit info
	...
	echo '<tr><th'.emailskin_style( 'table.email_table th' ).'>'.T_('Initial page').':</th><td'.emailskin_style( 'table.email_table td' ).'>'.T_('Collection')." ".$UserSettings->get( 'initial_blog_ID', $activated_User->ID )." - ".get_link_tag( $UserSettings->get( 'initial_URI', $activated_User->ID ), '', '.a', 60 ).'</td></tr>'."\n";
}
