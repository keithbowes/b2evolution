...
'Collection Folder URL' => 'Sammlungsordner-URL',
...
'Allow one main + several extra categories' => 'Eine Haupt- und mehrer Unterkategorien erlauben',
...
'Show in back-office favorites' => 'In Back-Office-Favoriten anzeigen',
...
'Meta comment from %s' => 'Meta-Kommentar von %s',
'Bad' => 'Schlecht',
'Poor' => 'Armselig',
...
'Manage this collection' => 'Diese Sammlung verwalten',
...
'Customize this collection' => 'Diese Sammlung anpassen',
...
'Post types with ID from %d to %d are reserved. Please use another ID.' => 'Eintragstypen mit der ID %d bis %d sind reserviert. Verwenden Sie bitte eine andere ID.',
'This post type already exists. Do you want to <a %s>edit the existing post type</a>?' => 'Dieser Eintragstyp existiert bereits. Möchten sie den <a %s>bereits existierenden Eintragstyp bearbeiten</a>?',
'New Post Type created.' => 'Neuer Eintragstyp wurde erstellt.',
'Post types with IDs = ( %d ) are reserved. You can not edit this post type.' => 'Eintragstypen mit den IDs = ( %d ) sind reserviert. Sie können diesen Eintragstyp nicht bearbeiten.',
'Post type updated.' => 'Eintragstyp aktualisiert.',
'Post types with ID from %d to %d are reserved. You can not delete this post type.' => 'Eintragstypen mit einer ID von %d bis %d sind reserviert. Sie können diesen Eintragstyp nicht löschen.',
...
'Post type' => 'Eintragstyp',
'Permission level' => 'Berechtigungslevel',
'Back-office tab' => 'Back-Office Tab',
'Items of this type will be listed in this back-office tab. If empty, items will be found only in the "All" tab.' => 'Elemente dieses Typs werden im Back-Office Tab aufgelistet. Falls dieser leer ist, befinden sich die Elemente nur in dem "Alle"-Tab.',
...
'The locale %s was re-enabled automatically because it\'s currently the default locale. The default locale must be a valid and enabled locale.' => 'Das Gebietsschema %s wurde wieder aktiviert, da es derzeit als Standard-Gebietsschema verwendet wird. Das Standard-Gebietsschema muss immer gültig und aktiviert sein.',
...
'(Re)generate POT file' => 'POT Datei (neu) generieren',
...
'We cannot reload the locale %s because the file %s was not found.' => 'Das Gebietsschema %s kann nicht geladen werden, da die Datei %s nicht gefunden wurde.',
...
'The file %s cannot be written to disk. Please check the filesystem permissions.' => 'Die Datei %s kann nicht auf die Festplatte geschrieben werden. Bitte überprüfen Sie die Dateisystemberechtigungen.',
...
'The requested thread does not exist any longer.' => 'Der angeforderte Thread existiert nicht mehr.',
...
'Renderer plugins settings' => 'Renderer-Plugin - Einstellungen',
...
'Removing broken posts that have no matching category... ' => 'Kaputte Einträge und zugehörige Kategorie entfernen...',
...
'Deleting of the orphan File objects from the database...' => 'Lösche die Orphan-Datei-Objekte aus der Datenbank...',
'Number of deleted orphan File objects: %d.' => 'Anzahl der gelöschten Orphan-Datei-Objekte: %d',
'Number of valid File objects in the database: %d.' => 'Anzahl der gültigen Datei-Objekte in der Datenbank: %d',
...
'PHP version must be 5.2 or higher to enable SMTP gateway.' => 'PHP Version muss 5.2 oder höher sein, um SMTP Gateway zu aktivieren.',
...
'Regular PHP "mail" function' => 'Reguläre PHP "Mail"-Funktion',
...
'Find and delete all orphan Tag entries (not used anywhere) - DB only.' => 'Finden und Löschen aller Orphan-Tag Einträge (nirgendwo benutzt) - nur DB.',
...
'Find and delete all orphan Comments (with no matching Item) - Disk &amp; DB.' => 'Finden und Löschen aller Orphan-Kommentare (ohne zugehörige Elemente) - Festplatte &amp; DB.',
'Find and delete all orphan comment Uploads - Disk &amp; DB.' => 'Finden und Löschen aller hochgeladenen Orphan-Kommentare - Festplatte &amp; DB.',
...
'Find and delete all orphan file roots (with no matching Collection or User) and all of their content recursively - Disk &amp; DB.' => 'Rekursives Finden und Löschen aller Orphan-Datei-Roots (ohne zugehörige Sammlung oder zugehörigem Benutzer) - Festplatte &amp; DB.',
...
'%s has posted %s photos. %s of these photos have been liked by %s different users.' => '%s hat %s Fotos eingetragen. Bei %s von diesen Fotos wurde von %s verschiedenen Benutzern "Gefällt mir" angeklickt.',
'%s has posted %s photos.<br />%s voted up (liked) by %s different users.<br />%s voted down by %s different users.<br />%s considered INAPPROPRIATE by %s different users.<br />%s considered SPAM by %s different users.' => '%s hat %s Fotos eingetragen.<br />%s von %s verschiedenen Benutzern haben dafür gestimmt (Gefällt mir).<br />%s von %s verschiedenen Benutzern haben dagegen gestimmt.<br />%s von %s verschiedenen Benutzern bezeichnen dies als UNANGEBRACHT<br />%s von %s verschiedenen Benutzern bezeichnen dies als SPAM.',
...
'Plugin user settings have been updated.' => 'Plugin-Benutzereinstellungen wurden aktualisiert',
...
'Url' => 'URL',
'Users of this organization' => 'Benutzer dieser Organisation',
...
'Pictures only' => 'Nur Bilder',
'User badges' => 'Benutzer-Abzeichen',
...
'You must turn on the <b>"Use coordinates"</b> setting in Post Type settings <a %s>Features</a> tab so the Google Maps plugin can save its coordinates.' => 'Sie müssen die Einstellung  <b>"Koordinaten verwenden"</b> in den Eintragstyp-Einstellungen unter <a %s>Features</a> aktivieren, damit das Google Maps Plugin seine Koordinaten speichern kann.',
...
'Top Heading Level' => 'Obere Überschriftshöhe',
'This plugin will adjust headings so they always start at the level you want: 2 for &lt;H2&gt;, 3 for &lt;H3&gt;, etc.' => 'Dieses Plugin wird die Überschriften so anpassen, dass sie immer auf der von Ihnen gewünschten Höhe beginnen: 2 für &lt;H2&gt;, 3 für &lt;H3&gt;, etc.',
...
'WARNING: By switching to WYSIWYG, you might lose newline and paragraph marks as well as some other formatting. Your text is safe though! Are you sure you want to switch?' => 'WARNUNG: Durch das Wechseln auf WYSIWYG können Zeilenvorschübe, Absatzmarkierungen, sowie andere Formatierungen verlorengehen. Ihr Text ist allerdings sicher! Sind Sie sicher, dass sie wechseln möchten?',
...
'Duplicate topic' => 'Thema duplizieren',
'Latest Replies' => 'Neueste Antworten',
