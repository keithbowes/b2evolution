...
'Your message has been sent by email.' => 'Ваше сообщение было отправлено по email.',
...
'image {current} of {total}' => 'изображение {current} из {total}',
'Previous' => 'Предыдущие',
'Next' => 'Следующие',
...
'Created by %s on %s' => 'Создано %s в %s',
' on ' => 'в',
...
'Collection Folder URL' => 'URL папки коллекции',
...
'Show in back-office favorites' => 'Показывать в избранных панели управления',
...
'Number of results per page' => 'Количество результатов на страницу',
'Number of comments shown' => 'Количество комментариев для показа',
...
'Meta comment from %s' => 'Мета комментарий от %s',
'Bad' => 'Плохо',
'Poor' => 'Слабо',
'Average' => 'Нормально',
'Excellent' => 'Отлично',
...
'Manage this collection' => 'Управление этой коллекцией',
'Write a new post' => 'Создать новую запись',
'Browse' => 'Обзор',
...
'Customize this collection' => 'Настроить эту коллекцию',
...
'No file selected' => 'Нет выбранного файла',
...
'Post Status has been updated.' => 'Статус Записи был обновлен.',
...
'Post types with ID from %d to %d are reserved. Please use another ID.' => 'Типы записей с %d по %d зарезервированы системой. Пожалуйста, используйте другой ID.',
'This post type already exists. Do you want to <a %s>edit the existing post type</a>?' => 'Такой тип записей уже существует. Хотите ли вы <a %s>редактировать существующий тип записи</a>?',
'New Post Type created.' => 'Новый Тип Записей создан.',
'Post types with IDs = ( %d ) are reserved. You can not edit this post type.' => 'Типы записей с ID = ( %d ) зарезервированы. Вы не можете редактировать это тип записи.',
'Post type updated.' => 'Тип записей обновлен.',
'Post types with ID from %d to %d are reserved. You can not delete this post type.' => 'Типы записей с ID от %d до %d зарезервированы. Вы не можете удалить этот тип записи.',
...
'%d recordings of a post having been read' => '%d записей о прочтении записи',
...
'Back-office tab' => 'Вкладка админ-части',
'Items of this type will be listed in this back-office tab. If empty, items will be found only in the "All" tab.' => 'Записи этого типа будут перечислены во вкладке админ-части. Если пусто, записи будут найдены только во вкладке "Все".',
...
'WARNING: <code>upgrade_policy.conf</code> not found. ALL FILES WILL BE BLINDLY UPGRADED WITHOUT DISCRIMINATION. Please refer to <code>/conf/upgrade_policy_sample.conf</code> for more info.' => 'ПРЕДУПРЕЖДЕНИЕ: файл <code>upgrade_policy.conf</code> не найден. ВСЕ ФАЙЛЫ БУДУТ ПОЛНОСТЬЮ ОБНОВЛЕНЫ БЕЗ РАЗБОРУ. Пожалуйста, обратитесь к файлу <code>/conf/upgrade_policy_sample.conf</code> для дополнительной информации.',
...
'Renderer plugins settings' => 'Настройки плагинов обработки текста',
...
'Save & Edit...' => 'Сохранить и Редактировать...',
...
'PHP version must be 5.2 or higher to enable SMTP gateway.' => 'PHP версия должна быть 5.2 или выше, чтобы включить SMTP шлюз.',
...
'Send test email message to "%s"...' => 'Отправить тестовое email сообщение "%s"...',
...
'This import step has already been processed.' => 'Этот шаг импорта уже был выполнен.',
...
'Regular PHP "mail" function' => 'Обычная PHP функция "mail"',
...
'send test email' => 'отправить тестовое email',
...
'%s has posted %s photos. %s of these photos have been liked by %s different users.' => '%s разместил %s фото. %s из тех фото понравились %s разным пользователям.',
'%s has posted %s photos.<br />%s voted up (liked) by %s different users.<br />%s voted down by %s different users.<br />%s considered INAPPROPRIATE by %s different users.<br />%s considered SPAM by %s different users.' => '%s разместил %s фото.<br />%s проголосовано "за"(понравилось) %s разными пользователями.<br />%s проголосовано "против" %s разными пользователями.<br />%s посчитано НЕУМЕСТНЫМИ %s разными пользователями.<br />%s посчитано СПАМОМ %s разными пользователями.',
...
'Secure options' => 'Безопасные настройки',
...
'Url' => 'Url',
'Users of this organization' => 'Пользователи этой организации',
...
'Women / Active / With Photo' => 'Женщины / Активные / С Фото',
'Women / Active / No Photo' => 'Женщины / Активные / Без Фото',
'Women / Inactive / With Photo' => 'Женщины / Неактивные / С Фото',
'Women / Inactive / No Photo' => 'Женщины / Неактивные / Без Фото',
'Women / Closed / With Photo' => 'Женщины / Закрытые / С Фото',
'Women / Closed / No Photo' => 'Женщины / Закрытые / Без Фото',
'Men / Active / With Photo' => 'Мужчины / Активные / С Фото',
'Men / Active / No Photo' => 'Мужчины / Активные / Без Фото',
'Men / Inactive / With Photo' => 'Мужчины / Неактивные / С Фото',
'Men / Inactive / No Photo' => 'Мужчины / Неактивные / Без Фото',
'Men / Closed / With Photo' => 'Мужчины / Закрытые / С Фото',
'Men / Closed / No Photo' => 'Мужчины / Закрытые / Без Фото',
'Unknown / Active / With Photo' => 'Неизвестные / Активные / С Фото',
'Unknown / Active / No Photo' => 'Неизвестные / Активные / Без Фото',
'Unknown / Inactive / With Photo' => 'Неизвестные / Неактивные / С Фото',
'Unknown / Inactive / No Photo' => 'Неизвестные / Неактивные / Без Фото',
'Unknown / Closed / With Photo' => 'Неизвестные / Закрытые / С Фото',
'Unknown / Closed / No Photo' => 'Неизвестные / Закрытые / Без Фото',
...
'De-activate' => 'Деактивировать',
'Widgets available for insertion into &laquo;%s&raquo;' => 'Виджеты доступные для добавления в &laquo;%s&raquo;',
'Multi-Purpose Widgets' => 'Многоцелевые Виджеты',
'Menu Item Widgets' => 'Виджеты Меню',
'Navigation Widgets' => 'Виджеты Навигации',
'Content Listing Widgets' => 'Виджеты Списков Содержимого',
'Info about a specific Item' => 'Информация о Записи',
'Collection Support Widgets' => 'Виджеты Поддержки Коллекций',
'Site Support Widgets' => 'Виджеты Поддержки Сайта',
'User Support Widgets' => 'Виджеты Поддержки Пользователя',
...
'Relative to the root of the selected source.' => 'Относительно корня выбранного источника.',
...
'Include an image.' => 'Включать изображение.',
...
'Pictures only' => 'Только фотографии',
'User badges' => 'Значки пользователей',
...
'User links' => 'Ссылки пользователей',
'Display user links.' => 'Показывать ссылки пользователей.',
...
'<p>This post has a special post type called "Post with custom fields".</p>' => '<p>Эта запись имеет специальный тип, называемый "Запись с пользовательскими полями".</p>',
'Custom Fields Example' => 'Пример Пользовательских Полей',
'<p>This post type defines 4 custom fields.</p>' => '<p>Этот тип записей определяет 4 пользовательских поля.</p>',
'<p>This post has sample values for these for 4 fields. You can see them below</p>' => '<p>Эта запись имеет примеры 4 полей. Вы можете увидеть их ниже</p>',
'<p>This post has a special post type called "Child Post".</p>' => '<p>Эта запись имеет специальный тип, называемый "Дочерняя Запись".</p>',
...
"<p>This is the first page.</p>\n\n<p>It appears in a single category.</p>" => "<p>Это первая страница.</p>\n\n<p>Она находится в одной рубрике.</p>",
'First Page' => 'Первая Страница',
"<p>This is the second page.</p>\n\n<p>It appears in multiple categories.</p>" => "<p>Это вторая страница.</p>\n\n<p>Она присутствует в нескольких рубриках.</p>",
...
'You must turn on the <b>"Use coordinates"</b> setting in Post Type settings <a %s>Features</a> tab so the Google Maps plugin can save its coordinates.' => 'Вы должны включить настройку <b>"Показывать координаты местоположения"<b> в настройках Типа Записей во вкладке <a %s>Возможности</a>, и плагин Google Карт сможет хранить их координаты.',
...
'Top Heading Level' => 'Верхний Уровень Заголовка',
'This plugin will adjust headings so they always start at the level you want: 2 for &lt;H2&gt;, 3 for &lt;H3&gt;, etc.' => 'Этот плагин будет регулировать заголовки, чтобы они всегда начинались с уровня, который вы хотите: 2 для &lt;H2&gt;, 3 для &lt;H3&gt;, и т.д.',
...
'WARNING: By switching to WYSIWYG, you might lose newline and paragraph marks as well as some other formatting. Your text is safe though! Are you sure you want to switch?' => 'ВНИМАНИЕ: Переключаясь на WYSIWYG, вы можете потерять новые линии, разметки параграфа и другие виды разметки. Даже если ваш текст является безопасным! Вы уверены, что хотите переключиться?',
...
'%s topics' => '%s топиков',
'%s replies' => '%s ответов',
'Thread started by' => 'Переписка была начата пользователем',
...
'Edit topic' => 'Редактировать топик',
'Duplicate topic' => 'Дублировать топик',
'Latest Replies' => 'Последние Ответы',
...
'Front Page Main Area Overlay' => 'Наложение на Главную Область Первой Страницы',
'Width' => 'Ширина',
'Middle' => 'Средний',
...
'Front Page Secondary Area Overlay' => 'Наложение Главной Страницы Второстепенной Области',
...
'If you did not request this password change, simply ignore this email.' => 'Если вы не запрашивали это изменение пароля, то просто игнорируйте это email сообщение.',
...
'If you need to attach files, please use <a %s>Advanced Edit</a>.' => 'Если вам необходимо прикрепить файлы, пожалуйста, используйте <a %s>Расширенное редактирование</a>.',
'If you need to attach additional files, please use <a %s>Advanced Edit</a>.' => 'Если вам необходимо прикрепить дополнительные файлы, пожалуйста, используйте <a %s>Расширенное редактирование</a>.',
'If you need to attach files, please add a comment right after you post this.' => 'Если вам необходимо прикрепить файлы, пожалуйста, добавьте комментарий сразу после того как вы опубликуете это.',
'If you need to attach additional files, please add a comment right after you edit this.' => 'Если вам необходимо прикрепить дополнительные файлы, пожалуйста, добавьте комментарий сразу после того как вы отредактируете это.',
