...
'You can share your keywords with and retrive keywords from the Central Antispam Blacklist service <a %s>Terms of service</a>' => 'Вы можете поделиться вашими ключевыми словами и получить новые из сервиса Центрального Черного Списка Антиспама <a %s>Условия использования</a>',
...
'Monthly alert on old contents' => 'Ежемесячное оповещение о старом контенте',
'Link' => 'Ссылка',
...
'Old content alert must be numeric (1-12).' => 'Оповещение о старом контенте должно быть числом (1-12).',
...
'Collection media file permission errors' => 'Ошибки прав медиа файла коллекции',
'Media directory &laquo;%s&raquo; could not be created.' => 'Медиа директория &laquo;%s&raquo; не может быть создана.',
'Collection media directory creation errors' => 'Ошибки создания медиа папки коллекции',
...
'See more option in Features &gt; <a %s>Posts</a>' => 'См. больше опций в Возможности &gt; <a %s>Записи</a>',
...
'Old content alert' => 'Оповещение о старом контенте',
...
'Open Graph tags (og:title, og:url, og:description, og:type and og:image)' => 'Open Graph теги (og:title, og:url, og:description, og:type and og:image)',
...
'You sent helpful vote.' => 'Вы отправили голос как полезный.',
...
'This field allows HTML code' => 'Это поле разрешает HTML код',
...
'Locale %s input date format cannot be empty' => 'Формат ввода даты у локали %s не может быть пустым',
'Locale %s time format cannot be empty' => 'Формат времени у локали %s не может быть пустым',
'Locale %s input time format cannot be empty' => 'Формат ввода времени у локали %s не может быть пустым',
...
'Flagged Items Menu Link' => 'Меню Ссылка Помеченных Записей',
...
'Flag icon' => 'Иконка пометки',
'Display flag icon' => 'Показывать иконку пометки',
...
'Display social links.' => 'Показывать социальные ссылки.',
...
'Insert thumbnail of cover image' => 'Вставить миниатюру изображения обложки',
'Insert excerpt' => 'Вставить выдержку',
'Insert teaser' => 'Вставить вступление',
'Insert "Read more" link' => 'Вставить ссылку "Читать далее"',
'Insert %s' => 'Вставить %s',
'Insert Complex Link' => 'Вставить Комплексную Ссылку',
