...
'No scheduled job has not been created for this campaign because no there are no waiting recipients for this campaing.' => 'Запланированная задача не была создана для этой кампании, потому что нет пользователей, ожидающих рассылку.',
...
'Locale %s date format cannot be empty' => 'Формат даты у локали %s не может быть пустым',
'Locale %s time format cannot be empty' => 'Формат времени у локали %s не может быть пустым',
'Locale %s short time format cannot be empty' => 'Короткий формат времени у локали %s не может быть пустым',
