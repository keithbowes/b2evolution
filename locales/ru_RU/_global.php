...
'Maximum number of collections allowed' => 'Максимальное количество разрешенных коллекций',
...
'Invalid Custom meta tag/css section. You can loosen this restriction in the <a %s>group settings</a>.' => 'Недопустимое значение Пользовательской css секции/мета тега. Вы можете ослабить это ограничение в <a %s>настройках группы</a>.',
'Invalid Custom javascript section. You can loosen this restriction in the <a %s>group settings</a>.' => 'Недопустимое значение Пользовательской javascript секции. Вы можете ослабить это ограничение в <a %s>настройках группы</a>.',
...
'Enter path to %s folder ending with / -- This may be located in a CDN zone' => 'Введите путь к папке %s, оканчивающийся на / -- Это может быть размещено в CDN зоне',
...
'Mark this comment as no opinion!' => 'Отметить этот комментарий как без мнения!',
'You have no opinion about this comment' => 'У вас пока нет мнения об этом комментарии',
...
'Execution time is more than 60 seconds!' => 'Время выполнения больше 60 секунд!',
...
'Sorry, you don\'t have an access to view scheduled jobs.' => 'Извините, у вас нет доступа к просмотру запланированных задач.',
...
'Please enter a text message.' => 'Пожалуйста, введите текст сообщения.',
...
'Campaign has been sent to a chunk of %s recipients. %s recipients were skipped. %s recipients have not been sent to yet.' => 'Кампания была отправлена порцией из %s получателей. %s получателей были пропущены. %s получателям еще не было отправлено сообщений.',
'Campaign has been sent to all recipients.' => 'Кампания была отправлена всем получателям.',
...
'A scheduled job has not been created for this campaign because no waiting users for newsletter.' => 'Запланированная задача не была создана для этой кампании, потому что нет пользователей, ожидающих рассылку.',
...
'Go to scheduler to see send jobs for this campaign' => 'Перейти к планировщику для просмотра отправленных задач этой кампании',
...
'Invalid instruction format. You can loosen this restriction in the <a %s>Group settings</a>.' => 'Недопустимый формат инструкции. Вы можете ослабить это ограничение в <a %s>Настройках группы</a>.',
...
'The locale %s is not readable. Please check file permissions.' => 'Локаль %s не читается. Пожалуйста, проверьте права файла.',
...
'Campaign sending' => 'Отправка кампании',
...
'%s user group' => '%s группа пользователей',
'%s user groups' => '%s группы пользователей',
...
'Set background image in Main Area section.' => 'Установите изображение фона для секции Главной Области.',
...
'Page link hover color' => 'Цвет ссылок на странице при наведении',
'Post background color' => 'Цвет фона записи',
...
'<span>Leave a comment <i class="fa fa-angle-double-right"></i></span>' => '<span>Оставить комментарий <i class="fa fa-angle-double-right"></i></span>',
...
'Use this background color when image is not selected above.' => 'Использовать этот цвет фона, когда изображение не выбрано выше.',
'Single column' => 'Одна колонка',
...
'Top margin (in %)' => 'Верхний отступ (в %)',
...
'Add a meta comment' => 'Добавить мета комментарий',
