 ...
 *
 * @version $Id: comment_new.html.php 8186 2015-02-06 22:24:19Z fplanque $
 */
...
echo get_link_tag( $Comment->get_permanent_url(), T_( 'Read full comment' ), 'div.buttons a+a.button_green' )."\n";
