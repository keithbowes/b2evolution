 ...
 *
 * @version $Id: _email_footer.inc.html.php 7639 2014-11-13 15:07:37Z yura $
 */
...
echo ' &bull; ';
echo '<a href="'.$htsrv_url.'/login.php?action=lostpassword"'.emailskin_style( '.a' ).'>'.T_('Lost password?').'</a>';
echo "</p>\n";

echo '<p'.emailskin_style( '.p' ).'><b>'.T_( 'Too many emails?' ).'</b><br />'."\n";
echo sprintf( T_('To configure the emails you receive, click here: <a %s>edit notification preferences</a>.'), 'href="'.$edit_notification_url.'"'.emailskin_style( '.a' ) );
