...
function create_default_data()
{
	...
	$DB->query( "
		...
		VALUES ( 1,    'Post',          'Posts',         'single', 1 ),
					 ...
					 ( 1400, 'Intro-Front',   " . T_('Intros') . ",        NULL,     1, 'restricted' ),
					 ( 1500, 'Intro-Main',    " . T_('Intros') . ",        NULL,     1, 'restricted' ),
					 ( 1520, 'Intro-Cat',     " . T_('Intros') . ",        NULL,     1, 'restricted' ),
					 ( 1530, 'Intro-Tag',     " . T_('Intros') . ",        NULL,     1, 'restricted' ),
					 ( 1570, 'Intro-Sub',     " . T_('Intros') . ",        NULL,     1, 'restricted' ),
					 ( 1600, 'Intro-All',     " . T_('Intros') . ",        NULL,     1, 'restricted' ),
					 ( 2000, 'Podcast',       " . T_('Podcasts') . ",      'single', 1, 'standard' ),
