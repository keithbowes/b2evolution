...
function create_default_data()
{
	...
	$DB->query( "
		...
		VALUES ( 1,    'Post',          'Posts',         'single', 1 ),
					 ( 100,  'Manual Page',   " . T_('Posts') . ",         'single', 0 ),
					 ( 200,  'Forum Topic',   " . T_('Posts') . ",         'single', 0 ),
					 ( 1000, 'Page',          " . T_('Pages') . ",         'page',   1 ),
					 ( 1400, 'Intro-Front',   " . T_('Intros') . ",        NULL,     1 ),
					 ( 1500, 'Intro-Main',    " . T_('Intros') . ",        NULL,     1 ),
					 ( 1520, 'Intro-Cat',     " . T_('Intros') . ",        NULL,     1 ),
					 ( 1530, 'Intro-Tag',     " . T_('Intros') . ",        NULL,     1 ),
					 ( 1570, 'Intro-Sub',     " . T_('Intros') . ",        NULL,     1 ),
					 ( 1600, 'Intro-All',     " . T_('Intros') . ",        NULL,     1 ),
					 ( 2000, 'Podcast',       " . T_('Podcasts') . ",      'single', 1 ),
					 ( 3000, 'Sidebar link',  " . T_('Sidebar links') . ", NULL,     1 ),
					 ( 4000, 'Advertisement', " . T_('Advertisement') . ", NULL,     1 ),
...
<p>It appears in multiple categories.</p>'), $now, $cat_manual_intro, array( $cat_manual_getstarted ),
		...
		$edited_Item = new Item();
		$edited_Item->set_tags_from_string( 'demo' );
		$edited_Item->insert( 1, T_('Wiki Tables'), /* DO NOT TRANSLATE - TOO COMPLEX */ '<p>This is the topic with samples of the wiki tables.</p>
