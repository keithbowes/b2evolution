...
$library_local_urls = array(
		...
		'#jqueryUI#' => array( 'jquery/jquery.ui.b2evo.js' ),
		'#jqueryUI_css#' => array( 'jquery/smoothness/jquery-ui.b2evo.css' ),
...
#		'#jqueryUI_css#' => array( 'jquery/smoothness/jquery-ui.min.css', 'jquery/smoothness/jquery-ui.css' ),
		...
		'#bootstrap_css#' => array( 'bootstrap/bootstrap.css' ),
		'#bootstrap_theme_css#' => array( 'bootstrap/bootstrap-theme.css' ),
		'#bootstrap_typeahead#' => array( 'bootstrap/typeahead.bundle.js' ),
		'#easypiechart#' => array( 'jquery/jquery.easy-pie-chart.js' ),
		'#scrollto#' => array( 'jquery/jquery.scrollto.js' ),
		'#touchswipe#' => array( 'jquery/jquery.touchswipe.js' ),
		'#jqplot#' => array( 'jquery/jqplot/jquery.jqplot.js' ),
		'#jqplot_barRenderer#' => array( 'jquery/jqplot/jqplot.barRenderer.js' ),
		'#jqplot_canvasAxisTickRenderer#' => array( 'jquery/jqplot/jqplot.canvasAxisTickRenderer.js' ),
		'#jqplot_canvasTextRenderer#' => array( 'jquery/jqplot/jqplot.canvasTextRenderer.js' ),
		'#jqplot_categoryAxisRenderer#' => array( 'jquery/jqplot/jqplot.categoryAxisRenderer.js' ),
		'#jqplot_enhancedLegendRenderer#' => array( 'jquery/jqplot/jqplot.enhancedLegendRenderer.js' ),
		'#jqplot_highlighter#' => array( 'jquery/jqplot/jqplot.highlighter.js' ),
		'#jqplot_canvasOverlay#' => array( 'jquery/jqplot/jqplot.canvasOverlay.js' ),
		'#jqplot_donutRenderer#' => array( 'jquery/jqplot/jqplot.donutRenderer.min.js', 'jquery/jqplot/jqplot.donutRenderer.js' ),
		'#jqplot_css#' => array( 'jquery/jquery.jqplot.css' ),
		'#tinymce#' => array( 'tiny_mce/tinymce.min.js' ),
		'#tinymce_jquery#' => array( 'tiny_mce/jquery.tinymce.min.js' ),
		'#flowplayer#' => array( 'flowplayer/flowplayer.js' ),
		'#mediaelement#' => array( 'mediaelement/mediaelement-and-player.js' ),
		'#mediaelement_css#' => array( 'mediaelement/mediaelementplayer.css' ),
		'#videojs#' => array( 'videojs/video.js' ),
		'#videojs_css#' => array( 'videojs/video-js.css' ),
		'#jcrop#' => array( 'jquery/jquery.jcrop.js' ),
		'#jcrop_css#' => array( 'jquery/jcrop/jquery.jcrop.css' ),
		'#fontawesome#' => array( 'font-awesome.css' ),
	);
