...
{ // default admin actions:
	...
	echo '<li><a href="'.regenerate_url('action', 'action=utf8upgrade&amp;'.url_crumb('tools')).'">'.T_('Check/Convert/Normalize the charsets/collations used by the DB (UTF-8 / ASCII) - DB only.').'</a></li>';
	echo '</ul>';
	$block_item_Widget->disp_template_raw( 'block_end' );
}
