...
class coll_search_form_Widget extends ComponentWidget
{
   ...
   *
	...
	function display( $params )
	{
		...
		echo '<input type="search" name="s" size="25" value="'.htmlspecialchars( (string) get_param( 's' ) ).'" class="search_field SearchField form-control" title="'.format_to_output( T_('Enter text to search for'), 'htmlattr' ).'" />';
