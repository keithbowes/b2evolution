...
{ // show main form
	...
	foreach( $locales as $lkey => $locale_data )
	{
		...
		$datefmt_input = $Form->get_input_element( array(
				...
				'size' => 6,
				'hide_label' => true ) );
		$longdatefmt_input = $Form->get_input_element( array(
				'type' => 'text',
				...
				'size' => 6,
				'hide_label' => true ) );
		$extdatefmt_input = $Form->get_input_element( array(
				'type' => 'text',
				...
				'size' => 6,
				'hide_label' => true ) );
		$input_datefmt_input = $Form->get_input_element( array(
				'type' => 'text',
		...
		$shorttimefmt_input = $Form->get_input_element( array(
				...
				'size' => 6,
				'hide_label' => true ) );
		$input_timefmt_input = $Form->get_input_element( array(
				'type' => 'text',
