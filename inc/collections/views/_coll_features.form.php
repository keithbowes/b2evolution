...
$Form->begin_fieldset( T_('Post options').get_manual_link('blog_features_settings'), array( 'id' => 'post_options' ) );
	...
	$Form->select_input_object( 'default_post_type', $edited_Blog->get_setting('default_post_type'), $ItemTypeCache, T_('Default type'), array( 'note' => T_('Default type for new posts') ) );
