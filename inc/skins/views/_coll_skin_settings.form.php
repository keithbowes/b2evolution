...
$Form->begin_form( 'fform' );
	...
	$fieldset_title_links = '<span class="floatright">&#160;'.action_icon( T_('Select another skin...'), 'choose', regenerate_url( 'action', 'ctrl=coll_settings&amp;skinpage=selection&amp;skin_type='.$skin_type ), ' '.T_('Choose a different skin').' →', 3, 4, array( 'class' => 'action_icon btn btn-info btn-sm' ) );
